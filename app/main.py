...
from app.custom_types import RAGChunkAndSrc,RAGQueryResult,RAGSearchResult,RAGUpsertResult
...
async def rag_ingest_pdf(ctx: inngest.Context):
    def _load(ctx: inngest.Context) -> RAGChunkAndSrc:
        ...
        return RAGChunkAndSrc(source_id=source_id, chunks=chunks)
...
async def rag_query_pdf_ai(ctx: inngest.Context) -> RAGSearchResult:
    ...
    user_content = (
        ...
        f"Context:\n{context_block}\n\n"
        f"Question: {question}\n"
        "Aswer concisely using the context above."
    )
    ...
    res = await ctx.step.ai.infer(
        ...
        body={
            ...
            "temperature": 0.2,
            "messages": [
                {"role": "system", "content": "You are a assistant that answers questions based on provided context."},
